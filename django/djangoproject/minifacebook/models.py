...
class Profile(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, db_index=False)
...
class Status(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, db_index=False)
    message = models.TextField(db_index=False)
    date_time = models.DateTimeField(db_index=True)
    profile = models.ForeignKey(Profile, null=False, on_delete=models.CASCADE, db_index=False)
